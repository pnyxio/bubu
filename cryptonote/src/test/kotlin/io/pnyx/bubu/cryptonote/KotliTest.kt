...
//    }
    ...
    fun `Check ECDSA public key on curve`() {
        ...
        // use edDSANamedCurveSpec curve for check.
    ...
    fun `ECDSA R1 keyPair from entropy`() {
        ...
        // BigIntenger.Zero is out or range, so 1 and hash(1.toCompressedPoint) would have the same impact.
        ...
        // BigIntenger.ONE is out or range, so 1 and hash(1.toCompressedPoint) would have the same impact.
